...
// Last modify by thirteenna on 04/07/2025.
//
        ...
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 16.0) {
                ...
                Image(.logo)
                    .resizable()
                    .scaledToFit()
                    .frame(maxWidth: .infinity, maxHeight: 90.0, alignment: .center)
                    .opacity(showLogo ? 1 : 0)
                    .animation(.easeIn(duration: 1.5), value: showLogo)
                    .blendMode(.multiply)
                ...
                Text("Faça login para que possamos te farejar!")
                    .font(.title3)
                ...
                NavigationLink {
                    ...
                    Text("Forasteiro? Comece por aqui.")
                        .bold()
