...
// Last Modify by Thirteena on 04/07/25.
//
...
struct SignUpView: View {
    ...
    let healthPlans: [String] = [
        "Dog Life", "PetLife", "Petlove", "WeVets", "APet", "PetMais Vida", "Pet Health", "Vital Pet"
    ]
    ...
    func register() async {
        ...
        do {
            ...
            isPatientRegistered = false
            print("Ocorreu um erro ao cadastrar você \(error)")
        }
        showAlert = true
    }
    ...
    var body: some View {
        ScrollView(showsIndicators: false) {
            VStack(alignment: .leading, spacing: 16.0) {
                ...
                Text("Olá, novo membro da matilha!")
                    .font(.title2)
                    .bold()
                ...
                TextField("Como seus tutores te chamam?", text: $name)
                    .padding(14)
                ...
                TextField("Insira o e-mail do seu tutor", text: $email)
                    .padding(14)
                    .background(Color.gray.opacity(0.25))
                    .cornerRadius(14.0)
                    .autocorrectionDisabled()
                ...
                TextField("Insira o CPF do seu tutor", text: $cpf)
                    .padding(14)
                    .background(Color.gray.opacity(0.25))
                    .cornerRadius(14.0)
                ...
                TextField("Insira o telefone do seu tutor", text: $phoneNumber)
                    .padding(14)
                    .background(Color.gray.opacity(0.25))
                    .cornerRadius(14.0)
                    .keyboardType(.numberPad)
                ...
                Text("Selecione o seu plano Pet")
                    .font(.title3)
                    .bold()
                    .foregroundStyle(.accent)
        ...
        .alert(isPatientRegistered ? "Sucesso!" : "Ops, algo deu errado!", isPresented: $showAlert, presenting: $isPatientRegistered) { _ in
            ...
            if isPatientRegistered {
                ...
                Text("Houve um erro ao cadastrar o você. Por favor tente novamente.")
            }
        }
